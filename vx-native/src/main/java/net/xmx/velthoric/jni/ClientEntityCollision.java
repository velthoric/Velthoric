...
/**
 * Client-side native interactions for entity-to-body collisions.
 * Provides direct communication via JNI to interface with the native Jolt collision structures.
 *
 * @author xI-Mx-Ix
 */
public class ClientEntityCollision {

    /**
     * Executes narrow-phase client-side collision resolution with active physics bodies.
     * Calculates sliding, platform velocity injection, and step climbing.
     *
     ...
     * @param dt               Dynamic frame calculation delta time step.
     */
    ...
    /**
     * Resolves client-side edge limits for sneaking entities on platforms.
     ...
     * with any active custom platform on the client.
     *
     * @param shapePtrs Contiguous direct buffer of shape pointers.
     ...
     * @return True if static collision intersections are discovered.
     */
